...
def get_alle_trainingen() -> list[dict]:
    """Genereer alle trainingsdatums van volgende week t/m 1 juli."""
    vandaag = date.today()
    # Start next Monday
    dagen_tot_maandag = (7 - vandaag.weekday()) % 7
    if dagen_tot_maandag == 0:
        dagen_tot_maandag = 7
    startdatum = vandaag + timedelta(days=dagen_tot_maandag)
